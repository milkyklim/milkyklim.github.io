...
const sketch = (s) => {
  ...
  s.preload = () => {
    hngImage = s.loadImage('./assets/images/banano/hng.svg');
    bananoLogo = s.loadImage('./assets/images/banano/banano-logo.svg');
    bananoLogoInv = s.loadImage('./assets/images/banano/banano-logo-2.svg');
  }
  ...
  s.mouseReleased = () => {
    ...
    s.image(hngImage, s.mouseX, s.mouseY);
